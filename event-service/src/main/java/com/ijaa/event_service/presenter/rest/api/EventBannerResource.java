...
import com.ijaa.event_service.service.EventBannerService;
...
@Slf4j
@RestController
@RequestMapping("/api/v1/user/events/banner")
@Tag(name = "Event Banner", description = "APIs for managing event banner images")
